...
export default async function HeaderSignUp(){
    return (
        <header
            ...
            <div className="flex items-center gap-4 text-[#0e151b]">
                <div className="size-14">
                    <Image src="/logo.png" alt="Logo" className="h-14 w-14" width={500} height={300}/> {/* Ajusta el tamaño según sea necesario */}
                </div>
            ...
            <div className="flex flex-1 justify-end gap-8">
                <div className="flex items-center gap-9">
                    ...
                    <a className="text-[#0e151b] text-sm font-medium leading-normal" href="./clinics/log-in">¿Ya tenias
                        cuenta?</a>
                </div>
            </div>
        </header>
